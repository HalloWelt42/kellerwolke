...
// vereinigt Mengen.
//
// Instanziierbar: erzeugeAuswahl() gibt eine EIGENE Auswahlmenge zurueck, damit
// die Einzelansicht und jede Splitscreen-Pane unabhaengig voneinander waehlen
// koennen. Der globale Export `auswahl` ist die Standard-Instanz.

export interface Auswahl {
  readonly ids: SvelteSet<string>;
...
export function erzeugeAuswahl(): Auswahl {
...
// Standard-Instanz (Einzelansicht). Abwaertskompatibel: bestehende Importe von
// `auswahl` funktionieren unveraendert.
export const auswahl = erzeugeAuswahl();
